...
class PhysiciansControllerTest < ActionController::TestCase
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post :create, physician: { dob: @physician.dob, email: @physician.email, first_name: @physician.first_name, last_name: @physician.last_name, mobile: @physician.mobile }
    end
  ...
  test "should update physician" do
    put :update, id: @physician, physician: { dob: @physician.dob, email: @physician.email, first_name: @physician.first_name, last_name: @physician.last_name, mobile: @physician.mobile }
    assert_redirected_to physician_path(assigns(:physician))
  end
